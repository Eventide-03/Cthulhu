...
//
// (It used to make the Now Playing player's icons too. Those are real art now,
// and this script writes without checking, so they were taken out of it --
// running it can no longer overwrite them.)
//
